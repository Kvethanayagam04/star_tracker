...
static void TURN_CW1(void);
static void TURN_CW2(void);
...
/* Variables for testing the angle*/
float test_angle1 = 90.0f, test_angle2 = 90.0f;
...
int main(void)
{
    ...
    /* USER CODE BEGIN 3 */
	/*if (test_angle1 != current_angle1)
	{
		next_step1 = stepper_step_angle(test_angle1, next_step1, 1);
	}
	if (test_angle2 != current_angle2)
	{
		next_step2 = stepper_step_angle(test_angle2, next_step2, 2);
	}*/
...
{
    float angleperstep = (motor == 1) ? 0.087890625 / 4.66739526 : 0.087890625;        // 360 = 4096 sequences
...
void TURN_CW2(void)
{
    // Step 0: A (PD7=1, PD6=0, PC5=0, PD4=0)
    ...
    // Step 1: AB (PD7=1, PD6=1, PC5=0, PD4=0)
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_7, GPIO_PIN_SET);
    ...
    // Step 2: B (PD7=0, PD6=1, PC5=0, PD4=0)
    ...
    // Step 3: BC (PD7=0, PD6=1, PC5=1, PD4=0)
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_7, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_6, GPIO_PIN_SET);
    ...
    // Step 4: C (PD7=0, PD6=0, PC5=1, PD4=0)
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_7, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_6, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_5, GPIO_PIN_SET);
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_4, GPIO_PIN_RESET);
    ...
    // Step 5: CD (PD7=0, PD6=0, PC5=1, PD4=1)
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_7, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_6, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_5, GPIO_PIN_SET);
    ...
    // Step 6: D (PD7=0, PD6=0, PC5=0, PD4=1)
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_7, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_6, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_5, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_4, GPIO_PIN_SET);
    ...
    // Step 7: DA (PD7=1, PD6=0, PC5=0, PD4=1)
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_7, GPIO_PIN_SET);
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_6, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_5, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_4, GPIO_PIN_SET);
